...
export interface ApiConsultationConsultation
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dateOfEnd: Schema.Attribute.DateTime & Schema.Attribute.Required;
    dateOfStart: Schema.Attribute.DateTime & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    recordedStudents: Schema.Attribute.Component<
      'recorded-students.recorded-students',
      true
    >;
