...
import {IEmployee} from "../../pages/MyProfilePage/MyProfilePage.tsx";
import './EmployeeCardSearch.scss'

export interface IEmployeeCardSearch {
    employee: IEmployee,
    link: string,
}

export const EmployeeCardSearch: FC<IEmployeeCardSearch> = ({employee, link}) => {
    const navigate = useNavigate();
    return (
        <div onClick={() => navigate(link ?? '/')}>
            <div className={'deanSmallCardContainer'}>
